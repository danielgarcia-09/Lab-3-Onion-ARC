...
using OnionArchitecture.Bl.IoC;
using OnionArchitecture.Core.IoC;
using OnionArchitecture.Core.Model;
using OnionArchitecture.IoC;
using OnionArchitecture.Model.Context;
using OnionArchitecture.Model.IoC;
using OnionArchitecture.Services.IoC;
using System;
...
namespace OnionArchitecture
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CompanyContext>(op => op.UseSqlServer(connectionString));
        }
